# GoldDrop - Сайт для открытия кейсов standoff 2 открывай-зарабатывай-выводи

Полнофункциональный сайт для открытия кейсов Standoff 2 с авторизацией через Steam, системой платежей
